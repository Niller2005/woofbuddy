  ...
  <div>
    <form class="formAuth" v-on:submit.prevent="onSubmit">
      ...
      <div
        ...
        role="alert"
      >Your email address has been successfully confirmed.</div>
      ...
      <label for="inputEmail" class="form-control-label sr-only">Email address</label>
      <input
        type="email"
        id="inputEmail"
        v-model="email"
      ...
      >
      <label for="inputPassword" class="form-control-label sr-only">Password</label>
      <input
        type="password"
        id="inputPassword"
        v-model="password"
